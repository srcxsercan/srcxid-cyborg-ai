...
echo "🌐 CYBORG-OS v22: Starship Sync Engine kuruluyor..."
...
# === SYNC ENGINE CLI ===
cat << 'JS' > $ROOT/src/cli/cyborg-sync.js
#!/usr/bin/env node
import fs from "fs";
...
chmod +x $ROOT/src/cli/cyborg-sync.js

echo "✅ CYBORG-OS v22 Starship Sync Engine tamamlandı!"
