...
echo "🧠 CYBORG-OS v24: Starship Brain 2.0 kuruluyor..."
...
cat << 'JS' > $ROOT/src/cli/cyborg-brain.js
#!/usr/bin/env node
import fs from "fs";
...
chmod +x $ROOT/src/cli/cyborg-brain.js

echo "✅ CYBORG-OS v24 Starship Brain 2.0 tamamlandı!"
